...
//It is developed using the C programming language for the purpose of storing name, symbol, atomic number, 
//atomic weight, and some important properties as well as to display them as per requirement of the user.
